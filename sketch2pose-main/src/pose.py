...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=MODELS_DIR / "hrn_w48_384x288.onnx",
    ...
    parser.add_argument(
        "--contact-model-path",
        type=str,
        default=MODELS_DIR / "contact_hrn_w32_256x192.onnx",
        help="Contact model",
    )
    ...
    parser.add_argument(
        "--spin-model-path",
        type=str,
        default=MODELS_DIR / "spin_model_smplx_eft_18.pt",
...
def main_infer_get_models(use_contacts, use_msc):
    ...
    smpl = spin.SMPLX(
        ...
        create_transl=False,
        use_pca=False,
        flat_hand_mean=False #args.fist is not None,
    )
    smpl.to(device)
